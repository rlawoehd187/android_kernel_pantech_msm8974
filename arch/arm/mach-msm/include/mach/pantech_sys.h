...
#define SYS_RESET_REASON_SKT_CHARGING_MASK 		0xDA0000B0
#define SYS_RESET_REASON_SKT_CHARGING 			0xDA0000B1
...
#define IS_SYS_SKT_CHARGING_MODE		((*(volatile unsigned int *)PANTECH_RESET_REASON_ADDR) & ~(0x00FFFF00)) == (SYS_RESET_REASON_SKT_CHARGING)

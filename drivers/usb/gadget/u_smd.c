...
static void load_phoneinfo_with_imei(struct work_struct *work_s)
{
	...
	read_result = read_offset_from_rawdata(/*NON_SECURE_IMEI_START*/ 328704, 16, read_buf); 
	...
	#ifdef CONFIG_PANTECH_SECBOOT
	{
		...
		read_result = read_offset_from_rawdata(/*PANTECH_SECBOOT_FLAG_START*/ 333824, SECTOR_SIZE, read_buf); 
		if (read_result != IDLE_PDL_ERROR_NONE)
		{
